...
export default function LandingPage() {
  return (
    <>
      <Particles className={"z-0 absolute top-0 left-0 w-screen h-screen"} />
      <div className="bg-black h-full flex-col">
            ...
            <div className="mb-16 lg:mb-0 lg:max-w-lg">
              <div className="mb-6 max-w-xl">
                ...
                <p className="text-base text-slate-200 md:text-lg">
                  ...
                  variety of stats, strats, and tips for the most popular games.
                </p>
              </div>
